    ...
    a.fn.flips = function(k) {
        ...
        this.initBlocks = function() {
            ...
            a('.block', h).each(function() {
                ...
                a(this).css('top', '0px');
                switch (k.direction) {
                    case'left': a(this).css('left', h.width() - a(this).width() * (page + 1));
                        break;
                    case'right': a(this).css('left', a(this).width() * page);
                        break;
                    case'top': a(this).css('top', h.height() - a(this).height() * (page + 1));
                        break;
                    case'bottom': a(this).css('top', a(this).height() * page);
                        break;
        ...
        this.clickRight = function(q) {
            ...
            for (var n = 0;
                ...
                n++) {
                    ...
                    case'left': p.css('left', -p.width());
                        m = {
                            left: 0
                        };
                        break;
                    case'right': p.css('left', h.width());
                        m = {
                            left: p.position().left - p.width()
                        };
                        break;
                    case'top': p.css('top', -p.height());
                        m = {
                            top: 0
                        };
                        break;
                    case'bottom': p.css('top', h.height());
                        m = {
        ...
        this.clickLeft = function() {
            ...
            for (var n = 0;
                ...
                n++) {
                    ...
                    case'left': p.css('left', h.width());
                        m = {
                            left: p.position().left - p.width()
                        };
                        break;
                    case'right': p.css('left', -p.width());
                        m = {
                            left: 0
                        };
                        break;
                    case'top': p.css('top', h.height());
                        m = {
                            top: p.position().top - p.height()
                        };
                        break;
                    case'bottom': p.css('top', -p.height());
                        m = {
                            top: 0
                        };
                        break;
